 ...
 * </p>
 * 
 * @author IceWee @date 2012-5-18 @version 1.0
 */
public class CFAESUtil {
	private final static Logger logger = Logger.getLogger(CFAESUtil.class);
	...
	public static String getSecretKey(String seed) throws Exception {
		...
		return CFBase64Util.encode(secretKey.getEncoded());
	}

	public static byte[] encrypt(byte[] data, String key) throws Exception {
		Key k = toKey(CFBase64Util.decode(key));
